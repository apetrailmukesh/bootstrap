<div id="mobileSort" class="reveal-modal mobile-sort" data-reveal>
	...
	<form class="mobile-sort-form">
		...
		<p><input type="radio" value="miles-1" id="miles-1" name="sort-options"><label for="miles-1">Mileage - Highest</label></p>
		<p><input type="radio" value="miles-0" id="miles-0" name="sort-options"><label for="miles-0">Mileage - Lowest</label></p>
		...
		<p><input type="radio" value="makemodel-1" id="makemodel-1" name="sort-options"><label for="makemodel-1">Make/Model - A to Z</label></p>
