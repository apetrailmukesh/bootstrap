...
<head>
	...
	<!-- favicon files -->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ URL::asset('images/apple-touch-icon-57x57.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ URL::asset('images/apple-touch-icon-60x60.png') }}">
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="{{ URL::asset('images/apple-touch-icon-144x144.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ URL::asset('images/apple-touch-icon-152x152.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ URL::asset('images/apple-touch-icon-180x180.png') }}">
    <link rel="icon" type="image/png" href="{{ URL::asset('images/favicon-194x194.png') }}" sizes="194x194">
    <link rel="icon" type="image/png" href="{{ URL::asset('images/android-chrome-192x192.png') }}" sizes="192x192">
    ...
    <meta name="msapplication-TileImage" content="{{ URL::asset('images/mstile-144x144.png') }}">
